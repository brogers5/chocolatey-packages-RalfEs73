...
$url        = 'https://github.com/Chia-Network/chia-blockchain/releases/download/1.2.0/ChiaSetup-1.2.0.exe'
$process	= "Chia"
...
$packageArgs = @{
  ...
  checksum      = '2FD014BE025329B7D6F9A4AEDB700A10543F16A40F849B26AE41ABB4FF08B039'
  checksumType  = 'sha256'

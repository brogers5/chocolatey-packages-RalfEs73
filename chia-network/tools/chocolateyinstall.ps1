...
$url        = 'https://github.com/Chia-Network/chia-blockchain/releases/download/2.1.0/ChiaSetup-2.1.0.exe'
...
$packageArgs = @{
  ...
  checksum      = '6BCA14CF13D496D65DA46777E1E4AA7A1ED61174FBB4947F82DC098F2110ECE8'
  checksumType  = 'sha256'

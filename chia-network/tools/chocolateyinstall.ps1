...
$url        = 'https://github.com/Chia-Network/chia-blockchain/releases/download/1.8.1/ChiaSetup-1.8.1.exe'
...
$packageArgs = @{
  ...
  checksum      = '41FC9CDFA3A6BC61C4C905620EF8503D8761521A17E77455FAA3DC1A6E1F4399'
  checksumType  = 'sha256'

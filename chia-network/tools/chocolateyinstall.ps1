...
$url        = 'https://github.com/Chia-Network/chia-blockchain/releases/download/1.3.3/ChiaSetup-1.3.3.exe'
$process	= "Chia"
...
$packageArgs = @{
  ...
  checksum      = '70EE22802C05584A0BD6BA05382EA9D8BDA319C6736B18D602E19E0F0E3F21BF'
  checksumType  = 'sha256'
